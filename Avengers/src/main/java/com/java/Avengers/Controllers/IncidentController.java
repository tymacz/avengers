...
public class IncidentController {
    ...
    @PostMapping
    public IncidentEntity addIncident(@RequestParam(required = false) String nature,@RequestParam(required = false) String commentaire) // Ajout du paramètre commentaire
    {
